...
<div class="dynamique_content"><h2><?php echo lang('accounting.add_new_bank_statement_label'); ?></h2>
    <div id="tabs-1">
        <?php echo form_open($this->uri->uri_string(), 'class="crud" id="incomes" name="incomes"'); ?> 								
        <fieldset>
            <div class="col600">
                ...
                <p><label for="incomes_type"><?php echo lang('common.type_label'); ?> :</label>
                    <select  name="income_type_id">
                        <option value="">#</option>
                        <?php foreach ($incomes as $key) : ?>
                            <option value="<?php echo $key->id; ?>"><?php echo $key->label; ?></option>
                        <?php endforeach; ?>
                    </select>
                </p>
                <p><label for="incomes_client"><?php echo lang('accounting.client_label'); ?> :</label>
                    <select  name="client_\id">
