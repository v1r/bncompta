...
<div class="dynamique_content"><h2><?php echo lang('accounting.add_new_bank_statement_label'); ?></h2>
    <div id="tabs-1">
        ...
        <fieldset>
            <div class="col600">
                <p><label for="expenditures_description"><?php echo lang('common.description_label'); ?> :</label>
                    <input class="mf" id="description" name="description" type="text" value="<?php echo $repopulate->description; ?>" />
                </p>
                <p><label for="expenditures_date"><?php echo lang('common.date_label'); ?> :</label>
                    <input class="mf" id="date" name="date" type="text" value="<?php echo $repopulate->date; ?>" />
                </p>
                <p><label for="expenditures_ht"><?php echo lang('accounting.ht_label'); ?> :</label>
                    <input class="mf" id="ammount" name="ht" type="text" value="<?php echo $repopulate->ht; ?>" />
                </p>
                <p><label for="expenditures_tva"><?php echo lang('accounting.tva_label'); ?> :</label>
                    <input class="mf" id="ammount" name="tva" type="text" value="<?php echo $repopulate->tva; ?>" />
                </p>
                <p><label for="expenditure_type"><?php echo lang('common.type_label'); ?> :</label>
        ...
        <fieldset>
            <legend>Importation a partir d'un releve bancaire</legend>
                <?php echo form_open('accounting/expenditures/import', 'class="crud" id="import_expenditures" name="import_expenditures"'); ?> 
                <p><label for="expenditures_bank_statements"><?php echo lang('accounting.bank_statements_label_2'); ?> :</label>
...
<script type="text/javascript">
    function ajaxFileUpload()
    {
        ...
        $.ajaxFileUpload(
        {
            url: BASE_URL + 'accounting/expenditures/upload_attachment',
            secureuri:false,
