...
class Manage extends Backend {
    ...
    public function index() {
        ...
        $users_data = $this->kb_auth_model->get_all_users($entreprise_id);
    ...
    public function add() {
        ...
        if ($this->form_validation->run('add_user') !== FALSE) {
            ...
            if ($this->kb_auth->add($username, $password, $email, $user_data, $type = '', $rules)) {
                // Flash success
    ...
    public function edit($user_id) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run('add_user') !== FALSE) {
                ...
                $rules = $this->input->post('methods');
                if ($this->kb_auth_model->update_user($user_id, $username, $password, $email, $user_data, $type = '', $rules)) {
                    // Flash success
            ...
            $repopulate = $this->kb_auth_model->get_user_data($user_id);
            $this->data->repopulate = $repopulate;
        }
