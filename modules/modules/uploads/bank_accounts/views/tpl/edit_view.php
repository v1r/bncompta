...
<div class="pad20">                
    ...
    <div id="tabs-1">
        <?php echo form_open('bank_accounts/manage/configure/' . $this->uri->segment(4) . '/update', 'class="crud" id="add_bank_account" name="ibanform"'); ?> 								
        <fieldset>
            <div class="col600">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <input  id="rib_bank_code" name="rib_bank_code" type="text" value="<?php echo trim(substr($repopulate->rib, 0, 5)); ?>" size="5" MAXLENGTH="5" style="width:50px;" />
                        </td>
                        <td><input  id="rib_branch_code" name="rib_branch_code" type="text" value="<?php echo trim(substr($repopulate->rib, 5, 5)); ?>" size="5" MAXLENGTH="5" style="width:50px;"/>

                        </td>
                        <td>  <input  id="rib_account_number" name="rib_account_number" type="text" value="<?php echo trim(substr($repopulate->rib, 10, 11)); ?>" size="11" MAXLENGTH="11" style="width:100px;"/>

                        </td>
                        <td><input   id="rib_key" name="rib_key" type="text" value="<?php echo trim(substr($repopulate->rib, 21, 2)); ?>" size="2" MAXLENGTH="2"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1"></td>
                ...
                <p class="tooltip" title="<?php echo lang('bank_accounts.iban_tooltips_label'); ?>">
                    ...
                    <input class="mf" id="iban" name="iban" type="text" value="<?php echo trim($repopulate->iban); ?>" />
