<div class="dynamic_content">   
    <h2><?php echo lang('accounting_year.add_new_accounting_year_label'); ?></h2>
    <div id="tabs-1">
        ...
        <fieldset>
            <div class="col600">
                ...
                <p><label for="accounting_year_start_date"><?php echo lang('common.start_date_label'); ?> :</label>
                    <input class="mf" id="start_date" name="start_date" type="text" value="<?php echo $repopulate->start_date; ?>" />
                </p>
                <p><label for="accounting_year_end_date"><?php echo lang('common.end_date_label'); ?> :</label>
                    <input class="mf" id="end_date" name="end_date" type="text" value="<?php echo $repopulate->end_date; ?>" />
                </p>
                <p><label for="accounting_year_is_default"><?php echo lang('common.is_default_label'); ?> :</label>
        ...
        $(document).ready(function(){
            ...
            $("#new_accounting_year").validate({
                ...
                messages: {
                    ...
                    is_default : {
                        required : "Le champ is_default est obligatoire"
                    }
                },
